...
public class Main {
    ...
    public static void mainMenu() {
        ...
        isAddRecipe(userInput);
        isDeleteRecipe(userInput);
        isEditRecipe(userInput);
        isAddInventory(userInput);
        isCheckInventory(userInput);
        isMakeCoffee(userInput);
    }
    
    public static void isAddRecipe(int userInput)
    {
    		if(userInput == 1) addRecipe();
    }
    
    public static void isDeleteRecipe(int userInput)
    {
    		if(userInput == 2) deleteRecipe();
    }
    
    public static void isEditRecipe(int userInput)
    {
    		if(userInput == 3) editRecipe();
    }
    
    public static void isAddInventory(int userInput)
    {
    		if(userInput == 4) addInventory();
    }
    
    public static void isCheckInventory(int userInput)
    {
    		if(userInput == 5) checkInventory();
    }
    
    public static void isMakeCoffee(int userInput)
    {
